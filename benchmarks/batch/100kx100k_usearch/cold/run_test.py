#!/usr/bin/env python3
"""Cold batch benchmark — 100k × 100k, usearch backend.

Clears cache and all outputs, then runs a full cold batch job.
Index build takes ~3-4 minutes on Apple Silicon M3.
Run from the project root:
    python3 benchmarks/batch/100kx100k_usearch/cold/run_test.py
"""
...
TEST_DIR = "benchmarks/batch/100kx100k_usearch/cold"
...
def main():
    ...
    print("Note: index build takes ~3-4 minutes on first run.\n")
    start = time.time()
