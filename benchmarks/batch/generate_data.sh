#!/usr/bin/env bash
#
# Generate all synthetic datasets required by benchmarks/batch/ benchmarks.
#
# Sizes needed:
...
#
# Usage:
#   ./benchmarks/batch/generate_data.sh              # all sizes
#   ./benchmarks/batch/generate_data.sh 10k           # just 10k
#   ./benchmarks/batch/generate_data.sh 10k 100k      # 10k and 100k
#   ./benchmarks/batch/generate_data.sh 1M            # just 1M (slow)
