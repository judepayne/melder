#!/usr/bin/env python3
"""Warm batch benchmark — 10k × 10k, flat backend.
...
for a true warm measurement. Run from the project root:
    python3 benchmarks/batch/10kx10k_flat/warm/run_test.py
"""
...
TEST_DIR = "benchmarks/batch/10kx10k_flat/warm"
...
def main():
    ...
    # Warm run: clear outputs but NOT cache
