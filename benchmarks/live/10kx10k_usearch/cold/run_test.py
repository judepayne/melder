#!/usr/bin/env python3
"""Cold live benchmark — 10k × 10k, usearch backend, 3k events at c=10.
...
Run from the project root:
    python3 benchmarks/live/10kx10k_usearch/cold/run_test.py
"""
...
TEST_DIR = "benchmarks/live/10kx10k_usearch/cold"
