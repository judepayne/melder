#!/usr/bin/env python3
"""Warm live benchmark — 10k × 10k, flat backend, 3k events at c=10.
...
Run from the project root:
    python3 benchmarks/live/10kx10k_inject3k_flat/warm/run_test.py
"""
...
TEST_DIR = "benchmarks/live/10kx10k_inject3k_flat/warm"
...
def main():
    ...
    # Warm: clear WAL and crossmap but NOT cache
